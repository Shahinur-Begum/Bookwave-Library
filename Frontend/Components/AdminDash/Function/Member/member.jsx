  ...
  const handleSaveEdit = () => {
    axios
      ...
      .then((response) => {
        ...
        setMembers(updatedMembers);  // <-- fix is here: update only members
        setIsEditDialogOpen(false);
        setMemberToEdit(null);
        // Removed resetting filteredMembers and searchTerm to let useEffect handle it
      })
